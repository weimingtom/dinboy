package it.gotoandplay.smartfoxserver
{
	...
	public class SFSEvent extends Event
	{
		 ...
		 * This event is dispatched only if the <i>autoConnect</i> parameter of the {@link SmartFoxClient#loadConfig} method is set to {@code true}; otherwise the connection is made and the {@link #onConnection} event fired.
		 * 
		...
		/**
		 * Dispatched when a room is left in multi-room mode, in response of a {@link SmartFoxClient#leaveRoom} request.
		 * 
		 * The {@link #params} object contains the following parameters.
